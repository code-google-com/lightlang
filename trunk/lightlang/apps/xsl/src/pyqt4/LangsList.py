...
def initLangsList() :
	...
	LangsListObject = [
		...
		[ tr("Icelandic"),	Qt.QVariant("is") ],
		[ tr("Indonesian"),	Qt.QVariant("id") ],
		[ tr("Irish"),		Qt.QVariant("ga") ],
		...
		[ tr("Macedonian"),	Qt.QVariant("mk") ],
		[ tr("Malay"),		Qt.QVariant("ms") ],
		[ tr("Maltese"),	Qt.QVariant("mt") ],
		[ tr("Norwegian"),	Qt.QVariant("no") ],
		[ tr("Persian"),	Qt.QVariant("fa") ],
		...
		[ tr("Welsh"),		Qt.QVariant("cy") ],
		[ tr("Yiddish"),	Qt.QVariant("yi") ]
		]
